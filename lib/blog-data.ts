...
export const blogPosts: BlogPost[] = [
  ...
  {
    slug: 'bank-5-day-work-week-2026-notification-status',
    title: 'Bank 5-Day Work Week 2026: Notification Status & Saturday Holiday Truth',
    metaTitle: 'Bank 5-Day Work Week 2026: Notification Status, Saturday Holiday Truth | TaiyarHo',
    metaDescription: 'Is bank 5-day work week approved in 2026? No — government approval is pending. AIBOC writes to PM Modi May 14. Current status, salary update, SBI PO IBPS PO impact explained.',
    category: 'Banking',
    tags: ['Bank 5-Day Work Week 2026', 'Bank Saturday Holiday 2026', '12th Bipartite Settlement', 'AIBOC 2026', 'Bank Working Days', 'SBI PO', 'IBPS PO', 'Bank Salary 2026'],
    publishedDate: 'May 14, 2026',
    updatedDate: 'May 14, 2026',
    readTime: '9 min read',
    author: 'TaiyarHo Editorial',
    excerpt: 'Thousands of bank aspirants and employees are waiting for the "all Saturdays off" notification. As of May 14, 2026, it has NOT been approved — but AIBOC has written to PM Modi today urging his personal intervention. Here is the complete, verified status.',
  },
  {
    slug: 'ibps-po-vs-sbi-po-2026',
    title: 'IBPS PO vs SBI PO 2026 — Salary, Difficulty & Which to Choose',
    metaTitle: 'IBPS PO vs SBI PO 2026: Salary, Difficulty & Which is Better? | TaiyarHo',
    metaDescription: 'IBPS PO vs SBI PO 2026 — complete comparison of salary (12th BPS), exam pattern, difficulty, vacancies, and career growth. Find out which bank PO is right for you.',
    category: 'Banking',
    tags: ['IBPS PO vs SBI PO', 'Bank PO 2026', 'SBI PO Salary 2026', 'IBPS PO Salary', '12th Bipartite Settlement', 'Bank PO Comparison', 'SBI PO vs IBPS PO'],
    publishedDate: 'May 16, 2026',
    updatedDate: 'May 16, 2026',
    readTime: '15 min read',
    author: 'TaiyarHo Editorial',
    excerpt: 'IBPS PO or SBI PO — which bank exam should you target in 2026? We compare salaries under the 12th Bipartite Settlement, exam difficulty, selection ratios, and career growth so you can make an informed choice.',
    examSlug: 'ibps-po',
  },
  {
    slug: 'easiest-government-exams-to-crack-2026',
    title: 'Top 10 Easiest Government Exams to Crack in 2026',
    metaTitle: 'Top 10 Easiest Government Exams to Crack in 2026 | TaiyarHo',
    metaDescription: 'Which government exam is easiest to crack in 2026? SSC MTS, RRB Group D, IBPS Clerk & more — ranked by syllabus difficulty, vacancies & real selection chances.',
    category: 'Preparation',
    tags: ['Easiest Government Exams 2026', 'SSC MTS 2026', 'RRB Group D 2026', 'IBPS Clerk 2026', 'Easy Sarkari Exams', 'Government Job 2026', 'India Post GDS', 'SSC CHSL 2026'],
    publishedDate: 'May 19, 2026',
    updatedDate: 'May 19, 2026',
    readTime: '14 min read',
    author: 'TaiyarHo Editorial',
    excerpt: 'Not every government exam requires two years of preparation. SSC MTS needs just 3 months. India Post GDS has no written test at all. Here are the 10 easiest government exams to crack in 2026 — ranked by syllabus difficulty, competition ratio, and real selection chances, with salary and notification dates.',
  },
  {
    ...
    metaDescription: 'Complete SSC CGL 2026 syllabus with topic-wise breakdown for Tier 1 and Tier 2, exam pattern, marking scheme, and free preparation tips. Updated May 2026.',
    category: 'SSC',
