...
export const exams: Exam[] = [
  {
    ...
    freeResources: [
      ...
      { name: 'Unacademy UPSC (Free)', type: 'youtube', url: 'https://www.youtube.com/@UnacademyIASEnglish', description: 'Free lectures by top educators on all GS subjects' },
      { name: 'StudyIQ IAS', type: 'youtube', url: 'https://www.youtube.com/@StudyIQEducationLtd', description: 'Current affairs and subject-wise lectures' },
  ...
  },
  {
    ...
    freeResources: [
      ...
      { name: 'Rakesh Yadav Maths (YouTube)', type: 'youtube', url: 'https://www.youtube.com/@rakeshyadav_sir', description: 'Mathematics shortcuts and problem solving' },
  ...
  },
  {
    ...
    freeResources: [
      ...
      { name: 'Exampur (YouTube)', type: 'youtube', url: 'https://www.youtube.com/@Exampur__Official', description: 'Free daily classes for Railway exams' },
  ...
  },
  {
    ...
    freeResources: [
      ...
      { name: 'Mrunal Patel (Economy & DI)', type: 'youtube', url: 'https://www.youtube.com/@TheMrunalPatel', description: 'Excellent free lectures on Economy and Data Interpretation' },
...

  {
    ...
    freeResources: [
      ...
      { name: 'Exampur (YouTube)', type: 'youtube', url: 'https://www.youtube.com/@Exampur__Official', description: 'Free daily classes, mock tests, and live discussions for RRB Group D preparation' },
      { name: 'StudyIQ (YouTube)', type: 'youtube', url: 'https://www.youtube.com/@StudyIQEducationLtd', description: 'Detailed concept videos for Maths, Reasoning, and Science fundamentals' },
  ...
  },
  {
    ...
    title: 'SSC GD Constable 2026 – Complete Preparation Guide',
    shortName: 'SSC GD',
    conductingBody: 'Staff Selection Commission (SSC)',
    category: 'Police',
    level: 'Central',
    frequency: 'Annual (Notification: December 2025 | CBT: April–May 2026)',
    avgVacancies: '25,487 vacancies (2026 cycle) | Cycle: BSF, CISF, CRPF, ITBP, SSB, AR, SSF, NCB',
    salaryRange: '₹21,700 – ₹69,100 per month (Pay Level 3) + HRA, DA & allowances',
    description: 'SSC GD Constable is one of India\'s largest central government recruitments. It recruits Constable (GD) in BSF, CISF, CRPF, ITBP, SSB, SSF, Rifleman (GD) in Assam Rifles, and Sepoy in NCB. Only a Class 10 pass is required. With 25,487 vacancies in the 2026 cycle and lakhs of applicants, it offers a prestigious uniformed career serving India\'s security forces.',
    officialWebsite: 'https://ssc.gov.in',
    minAge: 18,
    maxAge: 23,
    ageRelaxations: [
      { category: 'General / EWS', relaxation: 'No relaxation (18–23 years as on 01 Jan 2026)' },
      { category: 'OBC', relaxation: '+3 years (up to 26 years)' },
      { category: 'SC / ST', relaxation: '+5 years (up to 28 years)' },
      { category: 'PwBD (General/EWS)', relaxation: '+10 years' },
      { category: 'PwBD (OBC)', relaxation: '+13 years' },
      { category: 'PwBD (SC/ST)', relaxation: '+15 years' },
      { category: 'Ex-Servicemen', relaxation: '+3 years after deduction of military service' },
    ],
    qualification: 'Matriculation (Class 10) pass from a recognised Board/University. Candidates must have passed by 01 January 2026.',
    examStages: [
      {
        name: 'Stage 1 – Computer Based Examination (CBE)',
        subjects: [
        ...
        totalMarks: 160,
        duration: '60 minutes (no sectional timing) | PwBD: 80 minutes',
        type: 'MCQ – Objective | Negative marking: –0.25 per wrong answer | Available in English, Hindi & 13 regional languages',
      },
      {
        name: 'Stage 2 – Physical Efficiency Test (PET)',
        subjects: [
          'Male (General): 5 km run in 24 minutes',
          'Female (General): 1.6 km run in 8.5 minutes',
          'Male (Ladakh/Tribal regions): 1.6 km run in 6.5 minutes',
          'Female (Ladakh/Tribal regions): 800 m run in 4 minutes',
        ],
        totalMarks: 0,
        duration: 'Qualifying – no marks added to merit',
        type: 'Qualifying only | Ex-Servicemen are exempt from PET (appear only for PST)',
      },
      {
        name: 'Stage 3 – Physical Standard Test (PST)',
        subjects: [
          'Height: Male General/OBC/EWS – 170 cm | SC/ST – 162.5 cm | NE/Tribal – 162.5 cm',
          'Height: Female General/OBC/EWS – 157 cm | SC/ST – 150 cm | NE/Tribal – 150 cm',
          'Chest (Male only): Unexpanded – 80 cm | Expanded – 85 cm (minimum 5 cm expansion)',
          'Weight: Proportionate to height & age as per medical standards',
        ],
        totalMarks: 0,
        duration: 'Qualifying – no marks added to merit',
        type: 'Qualifying only | Height relaxation available for ST and specific tribal/NE categories',
      },
      {
        name: 'Stage 4 – Detailed Medical Examination (DME)',
        subjects: [
          'Vision: 6/6 in one eye and 6/9 in other eye (without glasses)',
          'Hearing, Mental Health, Chest, Limbs & Joints, Teeth, General Health',
          'Document Verification: Matriculation, Domicile, Caste, NCC certificate (if applicable)',
        ],
        totalMarks: 0,
        duration: 'Final qualifying stage',
        type: 'Qualifying only | Conducted by CAPF medical boards',
      },
    ],
    syllabus: [
      {
        ...
        topics: [
          ...
          'Direction Sense, Alphabet Test, Number Ranking',
          'Venn Diagrams, Syllogism, Statement & Conclusions',
          'Non-Verbal: Mirror Images, Water Images, Embedded Figures',
          'Paper Folding & Cutting, Figure Completion, Pattern Folding',
          'Mathematical Operations, Decision Making',
        ],
      },
      {
        subject: 'General Knowledge & General Awareness',
        topics: [
          'Current Affairs – India & World (last 6 months)',
          'Indian History – Ancient, Medieval, Modern, Freedom Struggle',
          'Indian Geography – Physical, Rivers, Climate, States',
          'Indian Polity – Constitution, Parliament, Fundamental Rights',
          'Indian Economy – Budgets, Agriculture, Schemes',
          'General Science – Physics, Chemistry, Biology (Class 10 level)',
          'Static GK – Sports, Books & Authors, Awards, Important Days',
          'Defence & Security Forces of India',
        ],
      },
      {
        ...
        topics: [
          ...
          'Time, Speed & Distance',
          'Mensuration – Area, Volume (Class 10 level)',
      ...
      },
      {
        ...
        topics: [
          ...
          '(Hindi) रिक्त स्थान भरें, वाक्य शुद्धि',
          '(Hindi) मुहावरे और लोकोक्तियाँ, विलोम–पर्यायवाची',
          '(Hindi) व्याकरण – संधि, समास, क्रिया, कारक',
        ],
      },
    ],
    bestBooks: [
    ...
    freeResources: [
      { name: 'SSC Official Previous Papers', type: 'website', url: 'https://ssc.gov.in', description: 'Official question papers and answer keys from SSC website — always check here first' },
      { name: 'Adda247 SSC GD (YouTube)', type: 'youtube', url: 'https://www.youtube.com/@adabornindia', description: 'Free video lectures for all SSC GD subjects in Hindi and English' },
      { name: 'Khan GS Research Centre (YouTube)', type: 'youtube', url: 'https://www.youtube.com/@KhanGSResearchCentre', description: 'GK and current affairs for SSC GD — popular with Hindi medium students' },
      { name: 'Testbook SSC GD Free Mocks', type: 'website', url: 'https://testbook.com/ssc-gd-constable', description: 'Free mock tests aligned to latest SSC GD pattern' },
      { name: 'Mahendra\'s Guru (YouTube)', type: 'youtube', url: 'https://www.youtube.com/@MahendrasGuru', description: 'Maths shortcuts and reasoning tricks for SSC GD aspirants' },
      { name: 'Gradeup / BYJU\'s Exam Prep (GD)', type: 'website', url: 'https://byjusexamprep.com/ssc-gd-constable-exam', description: 'Free practice questions, previous year papers and study notes' },
    ],
    studyPlan: [
      'Month 1 – Foundation: Start with Class 10 Maths (Number System, Percentage, Ratio). Revise basic Grammar rules for English/Hindi. Read Lucent GK: History and Geography chapters.',
      'Month 2 – Build Core: Move to Reasoning (Analogies, Series, Coding-Decoding, Blood Relations). Continue Maths (Profit-Loss, Time-Work, Speed-Distance). Start Current Affairs — read one newspaper or daily GK capsule.',
      'Month 3 – Complete Syllabus: Finish remaining Reasoning topics (Non-Verbal, Venn Diagrams, Syllogism). Cover Polity, Economy, Science in GK. Practice 50 questions daily.',
      'Month 4 – Mock Tests Begin: Take 1 full mock test every 3 days. Analyze mistakes topic-by-topic. Revise weak areas. Continue daily current affairs.',
      'Month 5 – Speed & Accuracy: 1 mock test daily. Target under 50 minutes for 80 questions. Revise all Maths formulas and GK facts. Solve previous 3 years SSC GD papers completely.',
      'Final 2 Weeks – Revision Sprint: No new topics. Only revise notes, important GK facts, formulas. Take 2 mocks daily. Also START physical training: run 1–2 km daily to prepare for PET.',
    ],
    faqs: [
      { question: 'Which forces recruit through SSC GD Constable 2026?', answer: 'SSC GD 2026 recruits for: Constable (GD) in BSF (Border Security Force), CISF (Central Industrial Security Force), CRPF (Central Reserve Police Force), ITBP (Indo-Tibetan Border Police), SSB (Sashastra Seema Bal), and SSF (Special Security Force); Rifleman (GD) in AR (Assam Rifles); and Sepoy in NCB (Narcotics Control Bureau). Post preferences are submitted by candidates and allocation depends on merit and vacancy.' },
      { question: 'What is the SSC GD 2026 exam date and total vacancies?', answer: 'The SSC GD 2026 Computer-Based Examination (CBE) is scheduled from 27 April to 30 May 2026. Admit cards have been released. A total of 25,487 vacancies were notified — 23,467 for male and 2,020 for female candidates across all forces.' },
      { question: 'Is 10th pass enough for SSC GD? What is the qualification?', answer: 'Yes. The minimum educational qualification is Matriculation (Class 10 pass) from a recognised Board or University. Candidates must have passed by 01 January 2026. Higher qualifications like 12th or graduation are not required and give no advantage.' },
      { question: 'What is the age limit for SSC GD 2026?', answer: 'The age limit for General/EWS candidates is 18 to 23 years as on 01 January 2026 (born between 02 January 2003 and 01 January 2008). Age relaxation: OBC +3 years, SC/ST +5 years, PwBD +10–15 years, Ex-Servicemen as per government rules.' },
      { question: 'What are the physical standards for SSC GD 2026?', answer: 'Male (General/OBC/EWS): Height 170 cm, Chest 80–85 cm (5 cm expansion). Female (General/OBC/EWS): Height 157 cm. For SC/ST and tribal/NE region candidates, relaxed standards apply. PET: Male run 5 km in 24 minutes, Female run 1.6 km in 8.5 minutes. Ex-Servicemen are exempt from the running test.' },
      { question: 'Is there an interview in SSC GD? How is the final merit decided?', answer: 'No, there is no interview. The final merit list is based entirely on your normalized CBT score. Additionally, NCC certificate holders get bonus marks: 2% for NCC "A", 3% for NCC "B", and 5% for NCC "C" certificate — added to the normalized CBT score.' },
      { question: 'What is the SSC GD Constable salary in 2026?', answer: 'SSC GD Constable pay is under Pay Level 3: ₹21,700 – ₹69,100 per month (basic). With DA, HRA, TA, ration money, and other allowances, the gross monthly in-hand salary typically ranges from ₹30,000 to ₹42,000 depending on posting location.' },
    ],
    tips: [
      'GK is the game-changer: Most students neglect GK, but it\'s 20 questions with no calculation needed. A well-prepared student can answer all 20 in under 4 minutes. Invest 30 min/day in GK from Day 1.',
      'Don\'t overlook Hindi/English: 20 questions from grammar and vocabulary. They are the easiest marks if you practice regularly. Choose Hindi if you\'re more comfortable — it\'s equally scoring.',
      'Maths stays at Class 10 level: No advanced algebra or geometry. Focus on speed — all formulas for percentage, profit-loss, and ratios should be instant. Practice 30 Maths questions daily with a timer.',
      'Start physical training NOW: Many candidates clear CBT but fail PET. Male candidates must run 5 km in 24 min (pace: ~4:48/km). Start running 3 days a week from Month 1 so there\'s no last-minute panic.',
      'Solve PYQ (Previous Year Papers) from 2019, 2021, 2023, and 2025: SSC GD repeats topic patterns. Previous papers reveal which chapters get more questions every cycle.',
      'Use the NCC advantage: If you have an NCC certificate (A, B, or C), get it attested — these bonus marks (2–5% of total) can make a decisive difference in your final merit rank.',
      'Negative marking is only –0.25: Don\'t leave questions blank if you can eliminate even 1 option. Attempting 70 questions with 60 correct is better than attempting only 50.',
    ],
  },
];
