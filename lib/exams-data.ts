...
export const allExams: ExamBrief[] = [
  ...
  { id:39, slug:'rpsc-ras', name:'RPSC RAS/RTS', conductingBody:'Rajasthan PSC', category:'State PSC', level:'State', frequency:'Annual', minAge:21, maxAge:40, qualification:'Graduation', selectionProcess:'Prelims, Mains, Interview', officialWebsite:'rpsc.rajasthan.gov.in', salaryRange:'₹44,900 – ₹2,09,200/month', avgVacancies:'600–1,100 annually', description:'Rajasthan Administrative Service exam for 607 State & Subordinate Service posts. Prelims 29 Nov 2026. Apply 4 Jun – 3 Jul 2026.' },
