...
export const allExams: ExamBrief[] = [
  ...
  { id:2, slug:'ssc-cgl', name:'SSC Combined Graduate Level (CGL)', conductingBody:'Staff Selection Commission (SSC)', category:'SSC', level:'Central', frequency:'Annual', minAge:18, maxAge:32, qualification:'Graduation', selectionProcess:'Tier I, Tier II', officialWebsite:'ssc.gov.in', salaryRange:'₹25,500 – ₹1,51,100/month', avgVacancies:'10,000–17,000 annually', description:'Recruits for Group B & C posts across central government ministries — Income Tax Inspector, CBI, Customs, CAG Auditor and more. One-time 5-year age relaxation announced (May 2026) for candidates affected by past recruitment delays — official circular awaited from SSC.' },
