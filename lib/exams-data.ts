...
export const exams: Exam[] = [
...

  {
    ...
    category: 'Railway',
    level: 'Central',
    frequency: 'Annual from 2024; CEN 09/2025 released January 2026 (next cycle expected Oct 2026)',
    avgVacancies: '22,195 (CEN 09/2025, Jan 2026); 32,438 in CEN-08/2024; 1,03,769 in CEN-RRC-01/2019 cycle',
    salaryRange: '\u20B918,000 – \u20B956,900 per month (Level 1, 7th CPC); 8th CPC revised basic ~\u20B932,940 (projected)',
    ...
    maxAge: 36,
    ageRelaxations: [
      { category: 'General / EWS', relaxation: '+3 years (one-time CEN 09/2025 relaxation)', },
      { category: 'OBC (Non-Creamy Layer)', relaxation: '+6 years (base +3, one-time +3)' },
      { category: 'SC / ST', relaxation: '+8 years (base +5, one-time +3)' },
      { category: 'PwBD (General)', relaxation: '+13 years (base +10, one-time +3)' },
      { category: 'PwBD (OBC)', relaxation: '+16 years (base +13, one-time +3)' },
      { category: 'PwBD (SC/ST)', relaxation: '+18 years (base +15, one-time +3)' },
      { category: 'Ex-Servicemen', relaxation: 'Service rendered + 3 years (post deduction)' },
      { category: 'Note', relaxation: 'CEN 09/2025 includes a one-time 3-year upper-age relaxation for General category. Standard upper age is 33 years. Always verify in the current notification on rrbcdg.gov.in.' },
    ],
    ...
    faqs: [
      ...
      { question: 'What is the salary of an RRB Group D employee?', answer: 'RRB Group D posts are at Pay Level 1 of the 7th CPC Pay Matrix with a starting basic pay of \u20B918,000. With DA (~55%), HRA, Travel Allowance, and other allowances, the in-hand salary was approximately \u20B922,500–\u20B926,000/month under 7th CPC. The 8th Pay Commission was implemented in early 2026; the projected revised Level 1 basic pay is ~\u20B932,940, which would raise the expected in-hand salary to approximately \u20B932,000–\u20B935,000/month (final fitment factor to be confirmed by late 2026). You also get free rail passes, medical facilities, pension under NPS, and other Indian Railways perks.' },
      { question: 'How often is RRB Group D notification released?', answer: 'Starting from 2024, RRB has moved to an Annual Recruitment Cycle. CEN-08/2024 (32,438 vacancies) was released January 2025, and CEN 09/2025 (22,195 vacancies) was released January 2026. The next cycle is expected around October 2026. Earlier cycles were irregular (e.g. CEN-RRC-01/2019 had 1,03,769 vacancies with a 3-year gap). Always check rrbcdg.gov.in for the current active notification.' },
...
export const allExams: ExamBrief[] = [
  ...
  { id:17, slug:'rrb-group-d', name:'RRB Group D', conductingBody:'Railway Recruitment Cell (RRC)', category:'Railway', level:'Central', frequency:'Annual (from 2024)', minAge:18, maxAge:36, qualification:'10th Pass / ITI', selectionProcess:'CBT, PET, DV, Medical', officialWebsite:'rrbcdg.gov.in', salaryRange:'₹18,000 – ₹56,900/month (8th CPC revised basic ~₹32,940)', avgVacancies:'22,195 posts (CEN 09/2025)', description:'Largest railway recruitment for Track Maintainer, Helper, Gateman and other Group D posts. Annual cycle from 2024.' },
