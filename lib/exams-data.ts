...
export const allExams: ExamBrief[] = [
  ...
  { id:21, slug:'upsc-capf', name:'UPSC CAPF Assistant Commandant', conductingBody:'Union Public Service Commission (UPSC)', category:'Defence', level:'Central', frequency:'Annual', minAge:20, maxAge:25, qualification:'Graduation', selectionProcess:'Written, PET/Medical, Interview', officialWebsite:'upsc.gov.in', salaryRange:'~₹85,000–₹95,000/month (gross in-hand)', avgVacancies:'200–400 annually', description:'Assistant Commandant (Group A) in BSF, CRPF, CISF, ITBP, SSB. 3-stage: Written + PET/Medical + Interview. One of the most respected officer-grade defence jobs after UPSC CSE.' },
