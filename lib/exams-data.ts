...
export const allExams: ExamBrief[] = [
  ...
  { id:88, slug:'rajasthan-police-constable', name:'Rajasthan Police Constable', conductingBody:'Rajasthan Police HQ', category:'Police', level:'State', frequency:'Irregular', minAge:18, maxAge:23, qualification:'12th Pass', selectionProcess:'Written, PET/PST, Proficiency Test', officialWebsite:'police.rajasthan.gov.in', salaryRange:'₹20,800 – ₹65,900/month', avgVacancies:'5,000–15,000', description:'Constable recruitment in Rajasthan Police.' },
