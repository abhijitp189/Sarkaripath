...
export const allExams: ExamBrief[] = [
  ...
  { id:71, slug:'iaf-agniveer', name:'IAF Agniveer Vayu', conductingBody:'Indian Air Force', category:'Defence', level:'Central', frequency:'Biannual', minAge:17, maxAge:22, qualification:'12th Pass / Diploma', selectionProcess:'Online Exam, PFT, Adaptability Test, Medical', officialWebsite:'iafrecruitment.edcil.co.in', salaryRange:'₹30,000 – ₹40,000/month (Yr 1–4)', avgVacancies:'State-wise as per service requirement', description:'Agniveer entry into Indian Air Force for technical and non-technical trades.' },
