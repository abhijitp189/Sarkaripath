...
export const allExams: ExamBrief[] = [
  ...
  { id:68, slug:'coast-guard-navik-db', name:'Indian Coast Guard Navik (DB)', conductingBody:'Indian Coast Guard', category:'Defence', level:'Central', frequency:'Biannual', minAge:18, maxAge:22, qualification:'10th Pass', selectionProcess:'CBT, PFT, Medical', officialWebsite:'joinindiancoastguard.cdac.in', salaryRange:'~₹28,000–₹33,000/month (gross in-hand)', avgVacancies:'100–200 per cycle', description:'Domestic Branch Navik in Indian Coast Guard for catering, steward, and housekeeping roles on ships and shore establishments. 10th pass eligible. Biannual intake.' },
