...
export const exams: Exam[] = [
  ...
  },
  {
    ...
    avgVacancies: 'TBA for 2026 (Notification awaited) | SSC CGL 2025 had 14,582 vacancies',
...
export const allExams: ExamBrief[] = [
  ...
  { id:2, slug:'ssc-cgl', name:'SSC Combined Graduate Level (CGL)', conductingBody:'Staff Selection Commission (SSC)', category:'SSC', level:'Central', frequency:'Annual', minAge:18, maxAge:32, qualification:'Graduation', selectionProcess:'Tier I, Tier II', officialWebsite:'ssc.gov.in', salaryRange:'₹25,500 – ₹1,51,100/month', avgVacancies:'TBA for 2026 — 15,000+ expected based on previous years', description:'Recruits for Group B & C posts across central government ministries — Income Tax Inspector, CBI, Customs, CAG Auditor and more. SSC CGL 2026 notification is delayed due to administrative reasons and is expected in late May/June 2026. Tier 1 exam expected June–July 2026. Use the official mySSC app for One-Time Registration (OTR) and Aadhaar-based verification.' },
