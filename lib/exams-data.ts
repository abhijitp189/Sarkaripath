...
export const allExams: ExamBrief[] = [
  ...
  { id:83, slug:'up-police-constable', name:'UP Police Constable', conductingBody:'UPPRPB', category:'Police', level:'State', frequency:'Irregular', minAge:18, maxAge:25, qualification:'12th Pass', selectionProcess:'Written, PST, PET, Medical', officialWebsite:'uppbpb.gov.in', salaryRange:'~₹26,000–₹32,000/month (gross in-hand)', avgVacancies:'25,000–50,000', description:'Largest state police constable recruitment in India. UP Police hires in massive numbers.' },
