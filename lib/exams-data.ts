...
export const allExams: ExamBrief[] = [
  ...
  { id:65, slug:'oicl-ao', name:'OICL Administrative Officer', conductingBody:'Oriental Insurance Company', category:'Banking', level:'Central', frequency:'Irregular', minAge:21, maxAge:30, qualification:'Graduation', selectionProcess:'Prelims, Mains, Interview', officialWebsite:'orientalinsurance.org.in', salaryRange:'₹50,925 – ₹96,765/month', avgVacancies:'100–300', description:'Administrative Officer (Scale I) recruitment in Oriental Insurance Company Limited. 300 vacancies notified in 2025-26.' },
  { id:66, slug:'nicl-ao', name:'NICL Administrative Officer', conductingBody:'National Insurance Company', category:'Banking', level:'Central', frequency:'Irregular', minAge:21, maxAge:30, qualification:'Graduation', selectionProcess:'Prelims, Mains, Interview', officialWebsite:'nationalinsurance.nic.in', salaryRange:'₹40,000 – ₹65,000/month', avgVacancies:'100–300', description:'AO recruitment in National Insurance Company.' },
