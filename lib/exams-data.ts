...
export const allExams: ExamBrief[] = [
  ...
  { id:86, slug:'bihar-police-constable', name:'Bihar Police Constable', conductingBody:'CSBC', category:'Police', level:'State', frequency:'Irregular', minAge:18, maxAge:25, qualification:'12th Pass', selectionProcess:'Written, PET/PST', officialWebsite:'csbcbihar.gov.in', salaryRange:'~₹26,000–₹32,000/month (gross in-hand)', avgVacancies:'5,000–20,000', description:'Constable recruitment in Bihar Police through CSBC. 12th pass eligible, age 18–25. Written test + PET/PST. Vacancies typically 5,000–20,000 per cycle.' },
