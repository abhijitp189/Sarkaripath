...
export const allExams: ExamBrief[] = [
  ...
  { id:98, slug:'upsssc-pet', name:'UPSSSC PET 2026 (Preliminary Eligibility Test)', conductingBody:'UP Subordinate Services Selection Commission', category:'State PSC', level:'State', frequency:'Annual', minAge:18, maxAge:40, qualification:'10th Pass (High School)', selectionProcess:'Written Exam – 100 MCQ, 2 Hours, No Negative Marking (gateway for further recruitment)', officialWebsite:'upsssc.gov.in', salaryRange:'₹19,900–₹1,12,400/month (varies by post)', avgVacancies:'10,000+ annually (Lekhpal, VDO, Clerk & more)', description:'Mandatory gateway exam for all UPSSSC Group C recruitments in UP. Clear PET once, apply for Lekhpal, VDO, Forest Guard and more. Score valid for 1 year. No negative marking.' },
