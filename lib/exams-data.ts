...
export const allExams: ExamBrief[] = [
  ...
  { id:82, slug:'delhi-police-constable', name:'Delhi Police Constable', conductingBody:'SSC / Delhi Police', category:'Police', level:'State', frequency:'Irregular', minAge:18, maxAge:25, qualification:'12th Pass', selectionProcess:'CBT, PE&MT, Medical', officialWebsite:'delhipolice.gov.in', salaryRange:'~₹35,000–₹42,000/month (gross in-hand)', avgVacancies:'5,000–15,000', description:'Constable (Executive) in Delhi Police for law and order duties.' },
