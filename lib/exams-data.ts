...
export const exams: Exam[] = [
  ...
  },
  {
    ...
    faqs: [
      { question: 'What is SBI PO 2026 notification date?', answer: 'SBI PO 2026 notification is expected in June 2026 based on the current exam cycle. The SBI careers portal shows the status as TBN (To Be Notified) as of May 2026. Prelims are expected in July 2026. Check sbi.co.in/web/careers regularly for official updates.' },
...
export const allExams: ExamBrief[] = [
  ...
  { id:12, slug:'sbi-clerk', name:'SBI Clerk (Junior Associates)', conductingBody:'State Bank of India (SBI)', category:'Banking', level:'Central', frequency:'Annual', minAge:20, maxAge:28, qualification:'Graduation', selectionProcess:'Prelims, Mains', officialWebsite:'sbi.co.in/careers', salaryRange:'~₹46,000/month (gross in-hand, at joining)', avgVacancies:'5,000–10,000 annually', description:'Junior Associate recruitment for SBI branches across India. Largest bank clerical recruitment.' },
