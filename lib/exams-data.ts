...
export const allExams: ExamBrief[] = [
  ...
  { id:9, slug:'ssc-mts', name:'SSC Multi Tasking Staff (MTS)', conductingBody:'Staff Selection Commission (SSC)', category:'SSC', level:'Central', frequency:'Annual', minAge:18, maxAge:27, qualification:'10th Pass', selectionProcess:'CBT, Physical Test (for Havaldar)', officialWebsite:'ssc.gov.in', salaryRange:'~₹18,000–₹22,000/month (gross in-hand, at joining)', avgVacancies:'5,000–10,000 annually', description:'Group C non-gazetted posts in central government. Includes MTS (General) and Havaldar in CBIC/CBN.' },
