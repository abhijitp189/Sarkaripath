...
export const allExams: ExamBrief[] = [
  ...
  { id:29, slug:'fci-assistant', name:'FCI Assistant Grade III', conductingBody:'Food Corporation of India (FCI)', category:'SSC', level:'Central', frequency:'Irregular', minAge:18, maxAge:27, qualification:'Graduation (subject-specific per post)', selectionProcess:'Phase I, Phase II (No Interview)', officialWebsite:'recruitmentfci.in', salaryRange:'₹41,790 – ₹46,900/month (in-hand to gross)', avgVacancies:'~27,345 (expected 2026 mega-cycle)', description:'FCI AG III is a Group C post in 5 departments — General, Accounts, Technical, Depot, Hindi. ~27,345 vacancies expected in 2026. Notification expected August 2026. Pay scale ₹28,200–₹79,200/month (IDA pattern).' },
