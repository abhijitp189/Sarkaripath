...
export const allExams: ExamBrief[] = [
  ...
  { id:42, slug:'tnpsc-group-1', name:'TNPSC Group 1', conductingBody:'Tamil Nadu PSC', category:'State PSC', level:'State', frequency:'Annual', minAge:21, maxAge:34, qualification:'Graduation', selectionProcess:'Prelims, Mains, Interview', officialWebsite:'tnpsc.gov.in', salaryRange:'₹56,100 – ₹2,05,700/month', avgVacancies:'80–170 annually', description:'Tamil Nadu\'s highest state services exam for Deputy Collector, DSP, Assistant Commissioner and other Group I officers. Notification 23 Jun 2026, Prelims 6 Sep 2026.' },
  ...
  { id:85, slug:'bihar-police-si', name:'Bihar Police Sub Inspector', conductingBody:'BPSSC', category:'Police', level:'State', frequency:'Irregular', minAge:20, maxAge:37, qualification:'Graduation', selectionProcess:'Prelims, Mains, PET/PST, Medical', officialWebsite:'bpssc.bihar.gov.in', salaryRange:'~₹61,000–₹71,000/month (gross in-hand)', avgVacancies:'1,700–2,500', description:'Sub Inspector (Daroga) in Bihar Police via BPSSC. Prelims + Mains + PET/PST + Medical. Graduation required, age 20–37 yrs. Gross salary ~₹61,000–₹71,000/month. Latest cycle Advt. 05/2025 offered 1,799 posts (Mains result out June 2026; PET/PST next).' },
  { id:86, slug:'bihar-police-constable', name:'Bihar Police Constable', conductingBody:'CSBC', category:'Police', level:'State', frequency:'Irregular', minAge:18, maxAge:25, qualification:'12th Pass', selectionProcess:'Written (qualifying), PET/PST (merit), DV, Medical', officialWebsite:'csbc.bihar.gov.in', salaryRange:'~₹30,000–₹40,000/month (gross in-hand)', avgVacancies:'5,000–20,000', description:'Constable recruitment in Bihar Police through CSBC. 12th pass eligible, age 18–25. Written test is qualifying only (30% min); final merit based entirely on PET marks (100). Last cycle: 19,838 vacancies (2025).' },
  { id:87, slug:'maharashtra-police-constable', name:'Maharashtra Police Constable', conductingBody:'Maharashtra State Police', category:'Police', level:'State', frequency:'Irregular', minAge:18, maxAge:28, qualification:'12th Pass', selectionProcess:'Physical Test (PET/PST), Written Exam', officialWebsite:'mahapolice.gov.in', salaryRange:'~₹30,000–₹38,000/month (gross in-hand)', avgVacancies:'10,000–17,000', description:'Police Constable/Shipai recruitment in Maharashtra Police. 15,631 vacancies in 2025-26 cycle. Pay Level S-7, basic ₹21,700. PET/PST completed; written exam ongoing district-wise.' },
  ...
  { id:89, slug:'mp-police-constable', name:'MP Police Constable', conductingBody:'MP Employees Selection Board', category:'Police', level:'State', frequency:'Irregular', minAge:18, maxAge:33, qualification:'10th / 12th Pass', selectionProcess:'Written, PET/PST', officialWebsite:'esb.mp.gov.in', salaryRange:'₹19,500 – ₹62,000/month', avgVacancies:'3,000–10,000', description:'Constable/Sipahi recruitment in Madhya Pradesh Police through MPESB. Age 18–33 (Male General), 18–38 (Female/OBC/SC/ST get +5). 10th/12th pass eligible. Written exam + PET/PST. Last cycle (2025): 7,500 posts completed. Vacancies typically 3,000–10,000 per cycle.' },
  ...
  { id:98, slug:'upsssc-pet', name:'UPSSSC PET 2026 (Preliminary Eligibility Test)', conductingBody:'UP Subordinate Services Selection Commission', category:'State PSC', level:'State', frequency:'Annual', minAge:18, maxAge:40, qualification:'10th Pass (High School)', selectionProcess:'Written Exam – 100 MCQ, 2 Hours, 0.25 Negative Marking (gateway for Group B & C recruitment)', officialWebsite:'upsssc.gov.in', salaryRange:'₹19,900–₹1,12,400/month (varies by post)', avgVacancies:'10,000+ annually (Lekhpal, VDO, Clerk & more)', description:'Mandatory gateway exam for all UPSSSC Group B & C recruitments in UP. Clear PET once, apply for Lekhpal, VDO, Forest Guard and more. Score valid for 3 years. Negative marking 0.25 per wrong answer.' },
