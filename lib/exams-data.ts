...
export const exams: Exam[] = [
  ...
  },
  {
    ...
    faqs: [
      { question: 'What is SBI PO 2026 notification date?', answer: 'SBI PO 2026 notification date has not been officially released yet. Based on historical patterns, SBI typically releases the PO notification in October–November. SBI PO 2025 notification was released in October 2024. Check sbi.co.in/web/careers regularly for official updates.' },
      ...
      { question: 'What is the SBI PO salary in 2026?', answer: 'SBI PO starting basic pay is ₹41,960/month (post 12th Bipartite Settlement). With Dearness Allowance (~53%), HRA (8–10%), City Compensatory Allowance, and other allowances, the total gross in-hand salary is approximately ₹65,000–₹75,000/month in metro cities — making it one of the highest-paying entry-level banking jobs in India.' },
