...
export const allExams: ExamBrief[] = [
  ...
  { id:57, slug:'supreme-court-jca', name:'Supreme Court Junior Court Assistant', conductingBody:'Supreme Court of India', category:'SSC', level:'Central', frequency:'Irregular', minAge:18, maxAge:30, qualification:'Graduation + 35 WPM Typing (English)', selectionProcess:'Objective CBT, Typing Test, Computer Test, Descriptive Test, Interview, Document Verification, Medical', officialWebsite:'main.sci.gov.in', salaryRange:'₹65,000 – ₹72,000/month (Gross)', avgVacancies:'150–250', description:'Junior Court Assistant (Group B) in the Supreme Court of India. 241 vacancies in 2025. Graduate + 35 WPM typing required. Pay Level 6, gross salary ~₹72,000/month. Prestigious central govt judicial role.' },
