...
export const exams: Exam[] = [
  ...
  },
  {
    ...
    ageRelaxations: [
      ...
      { category: '2026 One-Time Relief', relaxation: 'Union HM Amit Shah announced a one-time 5-year age relaxation for candidates who crossed the age limit due to SSC recruitment delays. Official gazette notification awaited — select "One-Time Relief" in the 2026 application form once notified. Verify at ssc.gov.in.' },
    ],
    ...
    faqs: [
      ...
      { question: 'How many times can I attempt SSC CGL?', answer: 'There is no limit on the number of attempts. You can appear every year as long as you meet the age criteria. The age is calculated as on August 1 of the exam year. Note (May 2026): Union HM Amit Shah has announced a one-time 5-year age relaxation for candidates who aged out due to SSC recruitment delays. The official SSC circular is awaited — watch ssc.gov.in for the formal notification.' },
