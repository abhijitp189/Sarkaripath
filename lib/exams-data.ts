...
export const allExams: ExamBrief[] = [
  ...
  { id:85, slug:'bihar-police-si', name:'Bihar Police Sub Inspector', conductingBody:'BPSSC', category:'Police', level:'State', frequency:'Irregular', minAge:20, maxAge:37, qualification:'Graduation', selectionProcess:'Prelims, Mains, PET, Medical', officialWebsite:'bpssc.bihar.gov.in', salaryRange:'~₹61,000–₹71,000/month (gross in-hand)', avgVacancies:'3,000–5,000', description:'Sub Inspector (Daroga) in Bihar Police. Prelims + Mains + PET + Medical. Graduation required, age 20–37 yrs. Gross salary ~₹61,000–₹71,000/month. BPSSC recruits in batches of 3,000–5,000.' },
