...
export const jun22_28_newsItems: NewsItem[] = [
  /* ── NATIONAL ─────────────────────────────────────────────────────────── */
  {
    id: 'mha-fcra-rules-amendment-2026',
    category: 'national',
    headline: 'MHA Amends Foreign Contribution (Regulation) Rules for NGOs',
  ...
  {
    id: 'nafed-nafex-platform-launch-2026',
    category: 'national',
    headline: 'Amit Shah Launches NAFEX.in Digital Agriculture Auction Platform',
  ...
  /* ── APPOINTMENTS ─────────────────────────────────────────────────────── */
  {
    id: 'tushar-mehta-solicitor-general-reappointed-2026',
    category: 'appointments',
    headline: 'Tushar Mehta Reappointed Solicitor General of India',
    eventDate: 'June 23, 2026',
    location: 'New Delhi',
    summary:
  ...
  {
    id: 'mahesh-dixit-ib-director-2026',
    category: 'appointments',
    headline: 'Mahesh Dixit Appointed Director of the Intelligence Bureau',
  ...
  /* ── AWARDS & HONOURS ─────────────────────────────────────────────────── */
  {
    id: 'padma-awards-2026-second-investiture',
    category: 'awards',
    headline: 'President Murmu Confers 65 Padma Awards at Second Investiture',
    eventDate: 'June 23, 2026',
    location: 'New Delhi',
    summary:
  ...
  /* ── SCIENCE & TECHNOLOGY ─────────────────────────────────────────────── */
  {
    id: 'isro-semi-cryogenic-engine-hot-test-2026',
    category: 'science',
    headline: 'ISRO Conducts 175-Tonne Hot Test of Semi-Cryogenic Engine',
  ...
  },
  {
    ...
    category: 'science',
    headline: 'India Conducts First GAGAN-Based Landing on a Jet Aircraft',
    eventDate: 'June 27, 2026',
  ...
  /* ── OBITUARIES ───────────────────────────────────────────────────────── */
  {
    id: 'alan-greenspan-dies-2026',
    category: 'obituaries',
    headline: 'Former US Federal Reserve Chairman Alan Greenspan Dies at 100',
    eventDate: 'June 22, 2026',
  ...
  /* ── IMPORTANT DAYS ───────────────────────────────────────────────────── */
  {
    ...
    examRelevance: ['SSC', 'Banking', 'Railway', 'State PSC', 'Police', 'Teaching'],
    staticGkConnect:
...
export const jun22_28_staticGk: StaticGkLink[] = [
  ...
  {
    newsItem: 'Tushar Mehta was reappointed Solicitor General of India.',
    staticFact:
...
export const jun22_28_quiz: QuizQuestion[] = [
  ...
  {
    id: 'jun22-q3',
    question: 'How many Padma Awards did President Murmu confer at the second Civil Investiture Ceremony of 2026?',
    options: ['56', '65', '106', '131'],
    correctIndex: 1,
    explanation:
      'President Droupadi Murmu conferred 65 Padma Awards (2 Padma Vibhushan, 7 Padma Bhushan, 56 Padma Shri) at the second investiture on June 23, 2026. A total of 131 were announced for 2026.',
    category: 'awards',
    difficulty: 'medium',
  },
  {
    id: 'jun22-q4',
    question: 'Mammootty, Alka Yagnik, and Vijay Amritraj were conferred which Padma Award in 2026?',
    options: ['Padma Shri', 'Padma Bhushan', 'Padma Vibhushan', 'Bharat Ratna'],
    correctIndex: 1,
    explanation:
      'Mammootty, Alka Yagnik, and tennis legend Vijay Amritraj were among the recipients of the Padma Bhushan at the second 2026 investiture.',
    category: 'awards',
    difficulty: 'medium',
  },
  {
    id: 'jun22-q5',
    question: 'At what thrust level did ISRO hot-test its semi-cryogenic engine power head in June 2026?',
    options: ['94 tonnes', '120 tonnes', '175 tonnes', '200 tonnes'],
    correctIndex: 2,
    explanation:
      'On June 24, 2026, ISRO tested the semi-cryogenic engine Power Head Test Article at 175 tonnes (about 88% of target) at IPRC, Mahendragiri, Tamil Nadu.',
    category: 'science',
    difficulty: 'hard',
  },
  {
    id: 'jun22-q6',
    question: 'The semi-cryogenic engine being developed by ISRO will replace which stage of the LVM3?',
    options: ['The S200 boosters', 'The L110 core stage', 'The C25 upper stage', 'The PSLV fourth stage'],
    correctIndex: 1,
    explanation:
      'The 2,000 kN-class SE2000 semi-cryogenic engine will power the SC120 stage, replacing the L110 liquid core stage of the LVM3.',
    category: 'science',
    difficulty: 'hard',
  },
  {
    id: 'jun22-q7',
    question: 'Mahesh Dixit was appointed the Director of which organisation in June 2026?',
    options: [
    ...
    correctIndex: 2,
    explanation:
      'Senior IPS officer Mahesh Dixit was appointed Director of the Intelligence Bureau (IB), succeeding Tapan Kumar Deka.',
    category: 'appointments',
    difficulty: 'easy',
  },
  {
    id: 'jun22-q8',
    question: 'Tushar Mehta was reappointed to which constitutional/statutory post in June 2026?',
  ...
  {
    id: 'jun22-q10',
    question: 'India conducted its first GAGAN-based landing approach on a jet aircraft at which airport in June 2026?',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'GAGAN (GPS Aided GEO Augmented Navigation) was jointly developed by ISRO and the Airports Authority of India (AAI).',
    category: 'science',
    difficulty: 'medium',
  },
  {
    id: 'jun22-q12',
    question: 'Alan Greenspan, who died in June 2026 at age 100, was the long-serving head of which institution?',
    options: ['World Bank', 'International Monetary Fund', 'US Federal Reserve', 'European Central Bank'],
    correctIndex: 2,
    explanation:
      'Alan Greenspan, nicknamed \"the Maestro\", was Chairman of the US Federal Reserve from 1987 to 2006 under four presidents. He died on June 22, 2026.',
    category: 'obituaries',
    difficulty: 'easy',
  },
  {
    id: 'jun22-q13',
    question: 'Which Union Minister launched the NAFEX.in digital auction platform in June 2026?',
    options: ['Nirmala Sitharaman', 'Piyush Goyal', 'Amit Shah', 'Shivraj Singh Chouhan'],
    correctIndex: 2,
    explanation:
      'Union Home and Cooperation Minister Amit Shah launched NAFEX.in, a NAFED-developed digital auction platform, on June 23, 2026.',
    category: 'national',
    difficulty: 'medium',
  },
  {
    id: 'jun22-q14',
    question: 'On June 22, 2026, the MHA amended the rules under which Act governing foreign funding of NGOs?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'The Ministry of Home Affairs amended the Foreign Contribution (Regulation) Rules, 2011 (under the FCRA, 2010) via a gazette notification on June 22, 2026.',
    category: 'national',
    difficulty: 'medium',
  },
];
