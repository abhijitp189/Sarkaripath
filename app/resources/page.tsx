...
const resourceSections: ResourceSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        desc: 'Government of India reference annual — covers government schemes, policies, economy, defence, and static GK. E-book versions available for download. Crucial for UPSC and SSC exams.',
        tags: ['UPSC', 'SSC'],
      },
    ],
  },
    ...
    items: [
      {
        ...
        url: 'https://testbook.com/online-test-series',
        desc: 'Industry-leading mock tests for SSC CGL, IBPS PO, SBI PO, RRB NTPC, UPSC, and 100+ more exams. 1,50,000+ tests available — free tier includes full-length mocks and daily live quizzes.',
        tags: ['All Exams'],
        badge: 'Most Popular',
      ...
      },
      {
        ...
        url: 'https://www.oliveboard.in/free-mock-test/',
        desc: 'Best-in-class free mock tests for Banking and Insurance exams — IBPS PO, Clerk, SBI PO, RBI Grade B, NABARD. 100+ free tests with detailed AI-based section-wise analysis.',
        tags: ['Banking'],
      },
      {
      ...
      },
      {
        ...
        url: 'https://byjusexamprep.com/free-mock-tests',
      ...
      },
      {
        ...
        desc: "Focused on SSC exams — CGL, CHSL, MTS. India's most trusted TCS-pattern test portal with chapter-wise and full-length mocks. Popular among serious SSC aspirants.",
        tags: ['SSC'],
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: 'SSC CGL — Pinnacle TCS Mock Tests',
        url: 'https://testportal.ssccglpinnacle.com/ssc/ssc-cgl-tier-1',
        desc: "Free chapter-wise and full-length practice tests for SSC CGL Tier 1 and Tier 2 on Pinnacle's TCS-pattern portal. Strong Maths and English content. Best free SSC resource online.",
        tags: ['SSC'],
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: 'Indian Railways — RRB Central Portal',
        url: 'https://www.rrcb.gov.in',
        desc: 'Central Railway Recruitment portal — links to all 21 RRB zone websites for NTPC, Group D, ALP, JE, and RPF notifications. Bookmark your zone for admit cards and results.',
        tags: ['Railway'],
        badge: 'Official',
        badgeColor: 'bg-emerald-100 text-emerald-700',
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: 'GS Score — Free UPSC Prelims Resources',
        url: 'https://iasscore.in/target-pt',
        desc: 'Free Prelims Sampoorna series — thematic current affairs compilation, PYQ-integrated notes, and topic-wise practice tests for UPSC Prelims 2026. Updated regularly till exam.',
        tags: ['UPSC'],
      },
      {
